...
export function toPost({ metadata, markdown }) {
  ...
  if (typeof metadata.description !== 'string' || metadata.description.length < 24 || metadata.description.length > 180) throw new Error('description must contain 24–180 characters');
